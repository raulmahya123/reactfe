      ...
      >
        ...
        <div className="relative max-w-6xl mx-auto px-6 text-center mb-28">
          ...
          <p className="mt-10 text-gray-600 max-w-3xl mx-auto leading-relaxed text-lg">
            PT Andalan Artha Primanusa Tbk menjalankan berbagai proyek operasional
            pertambangan di wilayah strategis Indonesia dengan standar profesional
            dan komitmen tinggi terhadap keselamatan kerja.
          </p>
        </div>
