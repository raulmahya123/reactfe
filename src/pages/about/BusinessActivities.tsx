...
const SegmentCard = ({
  ...
  <div className="group bg-white p-10 rounded-2xl shadow-md hover:shadow-2xl transition duration-500 border border-gray-100 hover:-translate-y-2">
    <div className="w-14 h-14 flex items-center justify-center rounded-xl bg-[#4A0404]/10 text-[#4A0404] mb-6 group-hover:bg-[#4A0404] group-hover:text-white transition">
      {icon}
    </div>
    <h3 className="text-xl font-semibold text-[#4A0404] mb-4">
      {title}
    </h3>
...
const BusinessActivities = () => {
  ...
  return (
    ...
    >
      ...
      <div className="mt-28 bg-[#4A0404] text-white py-20">
